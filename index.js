...
game = {
	...
	getState: function () {
		...
		if(results.length > 2 && results[1][1] > results[2][1]){
			height = results[2][1];
	...
	stop : function(){
		...
		totalScore += score;
		stepCount++;
		console.log("GAME STOPPED CURRENT SCORE " + score + " BEST SCORE SO FAR " + bestScoreSoFar + " StepCount " +
		stepCount + " totalScore " + totalScore);
