...
agent = {
    ...
    agent_step: function(nextState, reward, isTerminalState){
        ...
        delta =  reward + gamma*stateActionValue[nextStateActionKey.concat("+",nextAction)] -
        ...
        eligibilityTrace[stateActionKey.concat("+",currAction)] = (1 - alpha)*eligibilityTrace[stateActionKey.concat("+",currAction)] + 1;
