...
stepCount = 0;
totalScore = 0;
episodeStepCountLimitLearning = 1000;
episodeStepCountLimitEndGame = 1500;
...
game = {
	...
	stop : function(){
		...
		if(stepCount == episodeStepCountLimitLearning + 1){
			console.log("Stop Learning");
			alpha = 0;
		}

		if(stepCount <= episodeStepCountLimitEndGame) {
